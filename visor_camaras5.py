...
# --- VERSIÓN MEJORADA CON SALIDA DE FULLSCREEN MEJORADA ---
...
class CameraViewerApp:
    def __init__(self, window, window_title):
        ...
        self.fullscreen_canvas = tk.Canvas(self.fullscreen_frame, bg="black", cursor="hand2") #Añadimos cursor
    ...
    def enter_fullscreen(self, global_index):
        ...
        # --- CAMBIO 1: Vincular eventos para salir de pantalla completa ---
        self.fullscreen_canvas.bind("<Double-1>", self.exit_fullscreen)
        self.window.bind("<Escape>", self.exit_fullscreen)

    def exit_fullscreen(self, event=None): # Añadimos event=None para aceptar la llamada del evento
        ...
        # --- CAMBIO 2: Desvincular eventos para evitar conflictos ---
