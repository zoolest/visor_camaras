...
class CameraViewerApp:
    ...
    def update_page_view(self):
        ...
        # --- LÍNEAS AÑADIDAS PARA CORREGIR EL DISEÑO ---
        # Hacemos que las columnas de la cuadrícula se expandan para llenar el espacio
        for i in range(GRID_COLS):
            self.grid_frame.grid_columnconfigure(i, weight=1)
        # Hacemos que las filas también se expandan (calculamos cuántas filas habrá)
